...
block.OutputPort(1).Dimensions       = [1441 6]; 
...
persistent conn CollName Meas Meas_size
...
Meas_size=size(Meas);
block.OutputPort(1).Data(1:Meas_size(1),:) = Meas(1:Meas_size(1),:);
%end Outputs
